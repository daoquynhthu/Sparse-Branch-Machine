...
1. Run a controlled 64/128/256 sparse-output capacity curve on identical
...
2. Add failing tests for address-bucket pressure counters. Instrument occupied,
...
3. Replace the permissive malformed-cursor test with native and public API
