...
struct StepStats {
    ...
    float gpaf_unique_removed_cross_entropy{};
    float gpaf_unique_codelength_gain{};
    float gpaf_unique_false_positive_cost{};
    float gpaf_overlap_removed_cross_entropy{};
    float gpaf_overlap_codelength_gain{};
    float gpaf_overlap_false_positive_cost{};
    std::uint32_t gpaf_ablation_nodes{};
    std::uint32_t gpaf_unique_ablation_nodes{};
    std::uint32_t gpaf_overlap_ablation_nodes{};
...
struct Diagnostics {
    ...
    std::uint64_t gpaf_unique_candidates_returned{};
    std::uint64_t gpaf_overlap_candidates_returned{};
    std::uint64_t gpaf_unique_active_nodes{};
    std::uint64_t gpaf_overlap_active_nodes{};
